...
This repository does not currently grant a broad open-source license at the repository root. Do not assume permission to reuse, redistribute, or sublicense project-specific files unless a license file is added or written permission is provided by the rights holder.

Third-party components and SDKs have their own license terms. See `THIRD_PARTY_NOTICES.md` and the license files in those third-party directories before redistributing source or binary builds.
