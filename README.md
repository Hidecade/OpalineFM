...
The current public release is **v1.0.7**. Download Windows and macOS installers from the [v1.0.7 release page](https://github.com/Hidecade/OpalineFM/releases/tag/v1.0.7).

Choose the package for the format you need:

- `OpalineFM-Standalone-1.0.7.0-macOS.pkg`: standalone app. Use this if you want to play Opaline FM without a DAW.
- `OpalineFM-AU-1.0.7.0-macOS.pkg`: Audio Unit instrument for Logic Pro, GarageBand, and AU hosts.
- `OpalineFM-VST3-1.0.7.0-macOS.pkg`: VST3 instrument for VST3-compatible DAWs.
- `OpalineFM-Standalone-v1.0.7-Windows-x64.exe`: standalone application for 64-bit Windows.
- `OpalineFM-VST3-v1.0.7-Windows-x64.exe`: VST3 instrument installer for 64-bit Windows.
