...
現在の公開リリースは**v0.3.2**です。Windows版とmacOS版は [v0.3.2 Release](https://github.com/Hidecade/OpalineFM/releases/tag/v0.3.2) からダウンロードできます。
...
- `OpalineFM-Standalone-v0.3.2-Windows-x64.exe`: 64-bit Windows用スタンドアロンアプリ。
- `OpalineFM-VST3-v0.3.2-Windows-x64.exe`: 64-bit Windows用VST3インストゥルメント。
