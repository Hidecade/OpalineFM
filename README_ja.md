...
- スタンドアロン版のWAV録音
- Windowsスタンドアロン/VST3と、署名済みmacOSスタンドアロン/VST3/Audio Unitパッケージのビルド経路
...
Opaline FMはType Bレンダリングエンジンを既定で使用します。Type Bは、オペレーターのレベル処理、フィードバック、アッテネーション、キャリアミックス、出力挙動をチップ寄りに扱う主経路です。従来のType A比較用コントロールは公開UIでは非表示です。
